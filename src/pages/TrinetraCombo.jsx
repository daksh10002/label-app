...
import { Label_2x4_Trinetra_Combo } from "../templates/Label_2x4_Trinetra_Combo.jsx";

export default function TrinetraComboPage() {
    ...
    return (
        <Container size="lg" py="md">
            <Stack gap="md">
                <Title order={2}>Trinetra Combo Stickers</Title>
                ...
                {!loading && comboData && (
                    <Card withBorder p="sm" style={{ background: "#fff", width: "fit-content" }}>
                        ...
                        >
                            <Label_2x4_Trinetra_Combo data={comboData} />
                        </div>
                    </Card>
                )}
            </Stack>
