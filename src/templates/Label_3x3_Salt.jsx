// src/templates/Label_3x3_Salt.jsx

export function Label_3x3_Salt({ data }) {
  if (!data) return null;
    ...
    >
      <div
        style={{
          ...
          height: "3in",
          display: "block",
          padding: "15px 10px 5px 10px", // Shifted down
          boxSizing: "border-box",
        }}
      >
        {/* Row 1: Ingredients */}
        ...
        <div style={{ display: "block", marginBottom: "3px" }}>
          ...
          >
            <tbody>
              <tr>
                <td style={{ ...td, fontWeight: 700 }}>Sodium</td>
                <td style={{ ...td, textAlign: "right", fontWeight: 700 }}>{sodium}</td>
              </tr>
              <tr>
                <td style={{ ...td, fontWeight: 700 }}>Calcium</td>
                <td style={{ ...td, textAlign: "right", fontWeight: 700 }}>{calcium}</td>
              </tr>
              <tr>
                <td style={{ ...td, fontWeight: 700 }}>Potassium</td>
                <td style={{ ...td, textAlign: "right", fontWeight: 700 }}>{potassium}</td>
              </tr>
              <tr>
                <td style={{ ...td, fontWeight: 700 }}>Magnesium</td>
                <td style={{ ...td, textAlign: "right", fontWeight: 700 }}>{magnesium}</td>
              </tr>
              <tr>
                <td style={{ ...td, fontWeight: 700 }}>Iron</td>
                <td style={{ ...td, textAlign: "right", fontWeight: 700 }}>{iron}</td>
              </tr>
            </tbody>
          </table>
        </div>
